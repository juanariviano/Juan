export const projectapps = [
    ...
    {
      id: 1,
      name: "SunscreenChecker",
      description:
        "Recommend sunscreen based on current weather conditions.",
        github: "https://github.com/juanariviano/SunscreenChecker",
        deploy: "none",
    },
    {
      id: 2,
    ...
    },
    {
      id: 4,
      name: "DiagnoAI",
      description: "Machine Learning-based application designed to assist in predicting heart disease based on user health data.",
